...
namespace Jsyqw\BusinessGii\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    //自定义 start
    public $baseModelClass; //基础模型类
    public $tablePrefix='';
    public $onlyInitBaseModel = false;
    //自定义 end
    ...
    {
        return '根据数据库的表结构，自动生成model模型，1.以默认Base开头的模型类 2.生成继承Base的业务模型类';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['db', 'modelClass', "baseModelClass",'queryClass'], 'match', 'pattern' => '/^\w+$/', 'message' => 'Only word characters are allowed.'],
            ...
            [
                ['onlyInitBaseModel','generateLabelsFromComments', 'useTablePrefix', 'useSchemaName', 'generateQuery', 'generateRelationsFromCurrentSchema', 'useClassConstant', 'enableI18N', 'standardizeCapitals', 'singularize'],
                'boolean'
            ],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'baseModelClass' => '模型基类Base',
            'modelClass' => '业务模型类名',
            'baseClass' => '自定义ActiveRecord基类',
            'generateRelations' => '生成模型关系',
            ...
            'useClassConstant' => '使用 `::class`',
            'generateLabelsFromComments' => '使用DB注释，生成标签',
            'generateQuery' => '是否生成ActiveQuery类',
            'queryNs' => '查询类的 命名空间',
            'queryClass' => '查询类名称',
            'queryBaseClass' => '查询类的基类',
            'useSchemaName' => '使用模块名称',
            'useTablePrefix' => '使用表前缀模式',
            'tablePrefix' => '表前缀',//
            'onlyInitBaseModel' => '是否仅初始化Base的models',//
        ]);
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'tableName' => 'This is the name of the DB table that the new ActiveRecord class is associated with, e.g. <code>post</code>.
                ...
                class.',
            'baseModelClass' => '基础模型，直接跟数据库表映射，每次表有修改时候，当前类可以直接覆盖 示例： BaseUser.',
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                ...
                'onlyInitBaseModel' => $this->onlyInitBaseModel,
